...
IPMI|C|Collects temperatures, voltages, currents, power, fans and `SEL` events from IPMI using `libipmimonitoring`.<br/>&nbsp;<br/>netdata plugin: [freeipmi.plugin](https://github.com/firehol/netdata/blob/master/src/freeipmi_plugin.c)<br/>configuration file: none required|
