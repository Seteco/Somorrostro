...
- cpu usage of user `root` now <a href=""><img src="https://registry.my-netdata.io/api/v1/badge.svg?chart=users.cpu&dimensions=root&points=1&after=-1&value_color=grey:null%7Cgreen%3C10%7Cyellow%3C20%7Corange%3C50%7Cred&label=root%20user%20cpu&units=%25"></img></a>. This will be `green <10%`, `yellow <20%`, `orange < 50%`, `red` otherwise.
