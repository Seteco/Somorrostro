...
- average netdata requests per second during the last minute: <a href="https://registry.my-netdata.io/#netdata_netdata" target="_blank"><img src="https://registry.my-netdata.io/api/v1/badge.svg?chart=netdata.requests&dimensions=requests&points=1&after=-60&value_color=grey:null%7Cgreen&label=netdata%20web%20server%20last%20min&units=%5Cs"></img></a>
