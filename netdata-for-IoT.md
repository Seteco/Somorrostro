...
Netdata can serve as both a data collection agent (where you pull data using its API), but its charts can also be embedded in web pages / consoles, or it can be used directly by connecting to the device to view its dashboard.
